...
import heroBg from './assets/Images/img1.png'
import ss1 from './assets/Images/img2.png'
import ss2 from './assets/Images/img4.png'
import ss3 from './assets/Images/img5.png'
import ss4 from './assets/Images/img6.jpeg'
import ss5 from './assets/Images/img7.png'
import ss6 from './assets/Images/img8.png'
import ss7 from './assets/Images/img9.png'
import ss8 from './assets/Images/img10.png'
import ss9 from './assets/Images/img11.png'
    ...
    <>
      ...
      <footer id="footer" className="footer">
        ...
        <div className="footer-socials fade-in">
          <a href="https://discord.gg/T8GQSRQ5yg" target="_blank" rel="noopener noreferrer" className="social-link" id="social-discord">
          ...
          <a href="https://www.youtube.com/@TheGameLabyrinth" target="_blank" rel="noopener noreferrer" className="social-link" id="social-youtube">
            <svg viewBox="0 0 24 24">
              <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
            </svg>
            YouTube
          </a>
          <a href="https://x.com/game_labyrinth" target="_blank" rel="noopener noreferrer" className="social-link" id="social-x">
            <svg viewBox="0 0 24 24">
